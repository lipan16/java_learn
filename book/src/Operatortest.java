...
a=3+4;b=4*5;c=67-23;d=67/23;e=67%23;
...
System.out.println("****************************");
System.out.println("a>b="+(a>b));//关系运算得逻辑值
...
System.out.println("a="+a+",b="+b);//a加1但b没有加1
System.out.println("**************************");
a=142;b=186;c=a&b;d=a|b;e=a^b;
