...
public class ShootGame extends JPanel {
	...
	public static void main(String[] args) {
		JFrame frame = new JFrame("AirplaneGame");
	...
	int flyEnteredIndex = 0; // �������볡��ʱ

	/** �������볡 */
	public void enterAction() {
		flyEnteredIndex++;
		if (flyEnteredIndex % 40 == 0) { // 40��������һ��������
